...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\amanv8060_Leetcode-Questions\\solutions\\aka-working-space\\p1\\test-paths\\Solution_findMedianSortedArrays_vector_int_vector_int_random_1.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\amanv8060_Leetcode-Questions\\solutions\\aka-working-space\\p1\\execution-results\\Solution_findMedianSortedArrays_vector_int_vector_int_random_1.trc"
...
void AKA_TEST_Solution_findMedianSortedArrays_vector_int_vector_int_random_1(void) {
{
AKA_test_case_name="Solution_findMedianSortedArrays_vector_int_vector_int_random_1";
...
int nums1_element0=1337663386;
nums1.push_back(nums1_element0);
/* VectorDataNode nums2 */
int nums2_element0=-1990398430;
nums2.push_back(nums2_element0);
int nums2_element1=-1535765925;
nums2.push_back(nums2_element1);
/* NormalNumberDataNode RETURN */



AKA_mark("<<PRE-CALLING>> Test Solution_findMedianSortedArrays_vector_int_vector_int_random_1");double AKA_ACTUAL_OUTPUT=AKA_INSTANCE___Solution->findMedianSortedArrays(nums1,nums2);
...
int main()
{
    ...
    /* add & run the tests */
	AKA_run_test("SOLUTION_FINDMEDIANSORTEDARRAYS_VECTOR_INT_VECTOR_INT_RANDOM_1", &AKA_TEST_Solution_findMedianSortedArrays_vector_int_vector_int_random_1, 1);
