...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\amanv8060_Leetcode-Questions\\solutions\\aka-working-space\\p1\\test-paths\\Solution_findMedianSortedArrays_vector_int_vector_int_random_4.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\amanv8060_Leetcode-Questions\\solutions\\aka-working-space\\p1\\execution-results\\Solution_findMedianSortedArrays_vector_int_vector_int_random_4.trc"
...
#include "D:\\Projects\\AKAUT\\prj-data\\amanv8060_Leetcode-Questions\\solutions\\aka-working-space\\p1\\instruments\4.akaignore.cpp"
...
void AKA_TEST_Solution_findMedianSortedArrays_vector_int_vector_int_random_4(void) {
{
AKA_test_case_name="Solution_findMedianSortedArrays_vector_int_vector_int_random_4";
...
AKA_mark("Calling: \\Solution()|ROOT\\4.cpp\\GLOBAL\\AKA_INSTANCE___Solution\\AKA_INSTANCE___Solution\\Solution()");AKA_fCall++;AKA_INSTANCE___Solution = new ::Solution();
...
int nums1_element0=182981061;
nums1.push_back(nums1_element0);
/* VectorDataNode nums2 */
int nums2_element0=1284215793;
nums2.push_back(nums2_element0);
int nums2_element1=207265963;
nums2.push_back(nums2_element1);
int nums2_element2=890704282;
nums2.push_back(nums2_element2);
/* NormalNumberDataNode RETURN */



AKA_mark("<<PRE-CALLING>> Test Solution_findMedianSortedArrays_vector_int_vector_int_random_4");double AKA_ACTUAL_OUTPUT=AKA_INSTANCE___Solution->findMedianSortedArrays(nums1,nums2);
AKA_fCall++;AKA_mark("Return from: .\\p1\\4.cpp\\Solution\\findMedianSortedArrays(vector<int>&,vector<int>&)");
...
int main()
{
    ...
    /* add & run the tests */
	AKA_run_test("SOLUTION_FINDMEDIANSORTEDARRAYS_VECTOR_INT_VECTOR_INT_RANDOM_4", &AKA_TEST_Solution_findMedianSortedArrays_vector_int_vector_int_random_4, 1);
