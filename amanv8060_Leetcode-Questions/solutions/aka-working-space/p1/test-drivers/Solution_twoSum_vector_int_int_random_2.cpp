...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\amanv8060_Leetcode-Questions\\solutions\\aka-working-space\\p1\\test-paths\\Solution_twoSum_vector_int_int_random_2.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\amanv8060_Leetcode-Questions\\solutions\\aka-working-space\\p1\\execution-results\\Solution_twoSum_vector_int_int_random_2.trc"
...
#include "D:\\Projects\\AKAUT\\prj-data\\amanv8060_Leetcode-Questions\\solutions\\aka-working-space\\p1\\instruments\1.akaignore.cpp"
...
void AKA_TEST_Solution_twoSum_vector_int_int_random_2(void) {
{
...
AKA_mark("<<PRE-CALLING>> Test Solution_twoSum_vector_int_int_random_2");vector<int> AKA_ACTUAL_OUTPUT=AKA_INSTANCE___Solution->twoSum(arr,target);
AKA_fCall++;AKA_mark("Return from: .\\p1\\1.cpp\\Solution\\twoSum(vector<int>&,int)");
...
int main()
{
    ...
    /* add & run the tests */
	AKA_run_test("SOLUTION_TWOSUM_VECTOR_INT_INT_RANDOM_2", &AKA_TEST_Solution_twoSum_vector_int_int_random_2, 1);
