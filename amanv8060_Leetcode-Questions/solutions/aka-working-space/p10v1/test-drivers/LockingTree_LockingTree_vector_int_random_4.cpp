...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\amanv8060_Leetcode-Questions\\solutions\\aka-working-space\\p10v1\\test-paths\\LockingTree_LockingTree_vector_int_random_4.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\amanv8060_Leetcode-Questions\\solutions\\aka-working-space\\p10v1\\execution-results\\LockingTree_LockingTree_vector_int_random_4.trc"
...
#include "D:\\Projects\\AKAUT\\prj-data\\amanv8060_Leetcode-Questions\\solutions\\aka-working-space\\p10v1\\instruments\1993.akaignore.cpp"
/** Guard statement to avoid multiple declaration */
#ifndef AKA_GLOBAL_AKA_INSTANCE___LockingTree
#define AKA_GLOBAL_AKA_INSTANCE___LockingTree
::LockingTree* AKA_INSTANCE___LockingTree;
#endif
...
void AKA_TEST_LockingTree_LockingTree_vector_int_random_4(void) {
{
AKA_test_case_name="LockingTree_LockingTree_vector_int_random_4";
...
int AKA_INSTANCE___LockingTree_parent_element0=1925639794;
AKA_INSTANCE___LockingTree_parent.push_back(AKA_INSTANCE___LockingTree_parent_element0);
int AKA_INSTANCE___LockingTree_parent_element1=1687051455;
AKA_INSTANCE___LockingTree_parent.push_back(AKA_INSTANCE___LockingTree_parent_element1);
AKA_mark("<<PRE-CALLING>> Test LockingTree_LockingTree_vector_int_random_4");AKA_mark("Calling: .\\p10\\1993.cpp\\LockingTree\\LockingTree(vector<int>&)|ROOT\\1993.cpp\\GLOBAL\\AKA_INSTANCE___LockingTree\\AKA_INSTANCE___LockingTree\\LockingTree(vector<int>&)");AKA_fCall++;AKA_INSTANCE___LockingTree = new ::LockingTree(AKA_INSTANCE___LockingTree_parent);
...
/* ConstructorDataNode LockingTree(vector<int>&) */
/* VectorDataNode parent */
vector<int> EXPECTED_AKA_GLOBAL_AKA_INSTANCE___LockingTree_parent;
AKA_mark("<<PRE-CALLING>>");AKA_mark("Calling: .\\p10\\1993.cpp\\LockingTree\\LockingTree(vector<int>&)|ROOT\\1993.cpp\\GLOBAL\\AKA_INSTANCE___LockingTree\\AKA_INSTANCE___LockingTree\\LockingTree(vector<int>&)");AKA_fCall++;auto EXPECTED_AKA_GLOBAL_AKA_INSTANCE___LockingTree = new ::LockingTree(EXPECTED_AKA_GLOBAL_AKA_INSTANCE___LockingTree_parent);
/* VectorDataNode relations */
/* VectorDataNode locked */
...
int main()
{
    ...
    /* add & run the tests */
	AKA_run_test("LOCKINGTREE_LOCKINGTREE_VECTOR_INT_RANDOM_4", &AKA_TEST_LockingTree_LockingTree_vector_int_random_4, 1);
