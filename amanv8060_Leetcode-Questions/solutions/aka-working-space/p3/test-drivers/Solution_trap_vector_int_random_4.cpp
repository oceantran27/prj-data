...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\amanv8060_Leetcode-Questions\\solutions\\aka-working-space\\p3\\test-paths\\Solution_trap_vector_int_random_4.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\amanv8060_Leetcode-Questions\\solutions\\aka-working-space\\p3\\execution-results\\Solution_trap_vector_int_random_4.trc"
...
#include "D:\\Projects\\AKAUT\\prj-data\\amanv8060_Leetcode-Questions\\solutions\\aka-working-space\\p3\\instruments\42.akaignore.cpp"
...
void AKA_TEST_Solution_trap_vector_int_random_4(void) {
{
AKA_test_case_name="Solution_trap_vector_int_random_4";
...
AKA_mark("Calling: \\Solution()|ROOT\\42.cpp\\GLOBAL\\AKA_INSTANCE___Solution\\AKA_INSTANCE___Solution\\Solution()");AKA_fCall++;AKA_INSTANCE___Solution = new ::Solution();
...
/* RootDataNode STATIC */
/* VectorDataNode a */
int a_element0=2065840632;
a.push_back(a_element0);
int a_element1=-8425763;
a.push_back(a_element1);
/* NormalNumberDataNode RETURN */



AKA_mark("<<PRE-CALLING>> Test Solution_trap_vector_int_random_4");int AKA_ACTUAL_OUTPUT=AKA_INSTANCE___Solution->trap(a);
AKA_fCall++;AKA_mark("Return from: .\\p3\\42.cpp\\Solution\\trap(vector<int>&)");
...
int main()
{
    ...
    /* add & run the tests */
	AKA_run_test("SOLUTION_TRAP_VECTOR_INT_RANDOM_4", &AKA_TEST_Solution_trap_vector_int_random_4, 1);
