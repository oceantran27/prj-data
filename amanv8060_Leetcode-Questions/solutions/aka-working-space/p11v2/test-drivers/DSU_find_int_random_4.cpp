...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\amanv8060_Leetcode-Questions\\solutions\\aka-working-space\\p11v2\\test-paths\\DSU_find_int_random_4.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\amanv8060_Leetcode-Questions\\solutions\\aka-working-space\\p11v2\\execution-results\\DSU_find_int_random_4.trc"
...
void AKA_TEST_DSU_find_int_random_4(void) {
{
AKA_test_case_name="DSU_find_int_random_4";
...
int AKA_INSTANCE___DSU_n=1727738634;
...
/* VectorDataNode rank */
/* NormalNumberDataNode n */
AKA_INSTANCE___DSU->n=1727738634;
...
AKA_mark("<<PRE-CALLING>> Test DSU_find_int_random_4");int AKA_ACTUAL_OUTPUT=AKA_INSTANCE___DSU->find(x);
AKA_fCall++;AKA_mark("Return from: .\\p11\\1998.cpp\\DSU\\find(int)");
...
int main()
{
    ...
    /* add & run the tests */
	AKA_run_test("DSU_FIND_INT_RANDOM_4", &AKA_TEST_DSU_find_int_random_4, 1);
