...
; Variable "operations[10]" , real type = "string", class com.dse.parser.object.VariableNode
(declare-fun operations____arrbegin____10____arrend____ () String)
...
; Variable "operations[9]" , real type = "string", class com.dse.parser.object.VariableNode
(declare-fun operations____arrbegin____9____arrend____ () String)
