...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\amanv8060_Leetcode-Questions\\solutions\\aka-working-space\\p12v5\\test-paths\\Solution_akaLambdaFunction1018_vector_int_const_vector_int_const_random_0.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\amanv8060_Leetcode-Questions\\solutions\\aka-working-space\\p12v5\\execution-results\\Solution_akaLambdaFunction1018_vector_int_const_vector_int_const_random_0.trc"
...
#include "D:\\Projects\\AKAUT\\prj-data\\amanv8060_Leetcode-Questions\\solutions\\aka-working-space\\p12v5\\instruments\2008.akaignore.cpp"
...
void AKA_TEST_Solution_akaLambdaFunction1018_vector_int_const_vector_int_const_random_0(void) {
{
AKA_test_case_name="Solution_akaLambdaFunction1018_vector_int_const_vector_int_const_random_0";
...
/* RootDataNode STATIC */
/* VectorDataNode a */
int a_element0=287482728;
a.push_back(a_element0);
int a_element1=1306290846;
a.push_back(a_element1);
/* VectorDataNode b */
int b_element0=1401177089;
b.push_back(b_element0);
int b_element1=-873385599;
b.push_back(b_element1);
int b_element2=1732971018;
b.push_back(b_element2);



AKA_mark("<<PRE-CALLING>> Test Solution_akaLambdaFunction1018_vector_int_const_vector_int_const_random_0");[](const vector<int>& a, const vector<int>& b) { return a[0] < b[0]; }(a,b);
AKA_fCall++;AKA_mark("Return from: .\\p12\\2008.cpp\\Solution\\akaLambdaFunction1018(vector<int>const&,vector<int>const&)");

/* error assertion */
vector<int>const EXPECTED_a;

vector<int>const EXPECTED_b;
...
int main()
{
    ...
    /* add & run the tests */
	AKA_run_test("SOLUTION_AKALAMBDAFUNCTION1018_VECTOR_INT_CONST_VECTOR_INT_CONST_RANDOM_0", &AKA_TEST_Solution_akaLambdaFunction1018_vector_int_const_vector_int_const_random_0, 1);
