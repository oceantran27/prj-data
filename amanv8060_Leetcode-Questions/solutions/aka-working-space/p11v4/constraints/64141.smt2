...
; Variable "spf[12]" , real type = "int", class com.dse.parser.object.VariableNode
(declare-fun spf____arrbegin____12____arrend____ () Int)
(assert (and (>= spf____arrbegin____12____arrend____ -2147483648) (<= spf____arrbegin____12____arrend____ 2147483647)))
; Variable "spf[14]" , real type = "int", class com.dse.parser.object.VariableNode
(declare-fun spf____arrbegin____14____arrend____ () Int)
(assert (and (>= spf____arrbegin____14____arrend____ -2147483648) (<= spf____arrbegin____14____arrend____ 2147483647)))
; Variable "spf[16]" , real type = "int", class com.dse.parser.object.VariableNode
(declare-fun spf____arrbegin____16____arrend____ () Int)
(assert (and (>= spf____arrbegin____16____arrend____ -2147483648) (<= spf____arrbegin____16____arrend____ 2147483647)))
; Variable "spf[18]" , real type = "int", class com.dse.parser.object.VariableNode
(declare-fun spf____arrbegin____18____arrend____ () Int)
(assert (and (>= spf____arrbegin____18____arrend____ -2147483648) (<= spf____arrbegin____18____arrend____ 2147483647)))
...
(assert (not  (< 10 n) ) )
(assert (<  (* 2 2)  n) )
(assert (= spf____arrbegin____2____arrend____ 2) )
(assert (not  (> spf____arrbegin____4____arrend____ 2) ) )
(assert (not  (> spf____arrbegin____6____arrend____ 2) ) )
(assert (not  (> spf____arrbegin____8____arrend____ 2) ) )
(assert (< 10 n) )
(assert (> spf 10) )
(assert (not  (> spf____arrbegin____10____arrend____ 2) ) )
(assert (< 12 n) )
(assert (> spf 12) )
(assert (not  (> spf____arrbegin____12____arrend____ 2) ) )
(assert (< 14 n) )
(assert (> spf 14) )
(assert (not  (> spf____arrbegin____14____arrend____ 2) ) )
(assert (< 16 n) )
(assert (> spf 16) )
(assert (not  (> spf____arrbegin____16____arrend____ 2) ) )
(assert (< 18 n) )
(assert (> spf 18) )
(assert (not  (> spf____arrbegin____18____arrend____ 2) ) )
(check-sat)
(get-model)