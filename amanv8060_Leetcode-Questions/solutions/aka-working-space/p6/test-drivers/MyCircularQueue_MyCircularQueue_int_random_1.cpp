...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\amanv8060_Leetcode-Questions\\solutions\\aka-working-space\\p6\\test-paths\\MyCircularQueue_MyCircularQueue_int_random_1.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\amanv8060_Leetcode-Questions\\solutions\\aka-working-space\\p6\\execution-results\\MyCircularQueue_MyCircularQueue_int_random_1.trc"
...
#include "D:\\Projects\\AKAUT\\prj-data\\amanv8060_Leetcode-Questions\\solutions\\aka-working-space\\p6\\instruments\622.akaignore.cpp"
/** Guard statement to avoid multiple declaration */
#ifndef AKA_GLOBAL_AKA_INSTANCE___MyCircularQueue
#define AKA_GLOBAL_AKA_INSTANCE___MyCircularQueue
::MyCircularQueue* AKA_INSTANCE___MyCircularQueue;
#endif
...
void AKA_TEST_MyCircularQueue_MyCircularQueue_int_random_1(void) {
{
AKA_test_case_name="MyCircularQueue_MyCircularQueue_int_random_1";
...
int AKA_INSTANCE___MyCircularQueue_k=948098253;
AKA_mark("<<PRE-CALLING>> Test MyCircularQueue_MyCircularQueue_int_random_1");AKA_mark("Calling: .\\p6\\622.cpp\\MyCircularQueue\\MyCircularQueue(int)|ROOT\\622.cpp\\GLOBAL\\AKA_INSTANCE___MyCircularQueue\\AKA_INSTANCE___MyCircularQueue\\MyCircularQueue(int)");AKA_fCall++;AKA_INSTANCE___MyCircularQueue = new ::MyCircularQueue(AKA_INSTANCE___MyCircularQueue_k);
/* NormalNumberDataNode front */
AKA_INSTANCE___MyCircularQueue->front=-1837913051;
/* NormalNumberDataNode rear */
AKA_INSTANCE___MyCircularQueue->rear=-2002876396;
/* NormalNumberDataNode size */
AKA_INSTANCE___MyCircularQueue->size=-250789134;
/* NormalNumberDataNode max_size */
AKA_INSTANCE___MyCircularQueue->max_size=-875555581;
/* VectorDataNode vec */
int AKA_INSTANCE___MyCircularQueue_vec_element0=1785683309;
AKA_INSTANCE___MyCircularQueue->vec.push_back(AKA_INSTANCE___MyCircularQueue_vec_element0);
int AKA_INSTANCE___MyCircularQueue_vec_element1=786310623;
...
int main()
{
    ...
    /* add & run the tests */
	AKA_run_test("MYCIRCULARQUEUE_MYCIRCULARQUEUE_INT_RANDOM_1", &AKA_TEST_MyCircularQueue_MyCircularQueue_int_random_1, 1);
