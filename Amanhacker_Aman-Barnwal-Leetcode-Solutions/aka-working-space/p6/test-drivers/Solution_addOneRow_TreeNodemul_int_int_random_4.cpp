...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p6\\test-paths\\Solution_addOneRow_TreeNodemul_int_int_random_4.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p6\\execution-results\\Solution_addOneRow_TreeNodemul_int_int_random_4.trc"
...
void AKA_TEST_Solution_addOneRow_TreeNodemul_int_int_random_4(void) {
{
AKA_test_case_name="Solution_addOneRow_TreeNodemul_int_int_random_4";
...
AKA_mark("Calling: .\\p6\\0623-add-one-row-to-tree\\0623-add-one-row-to-tree.cpp\\TreeNode\\TreeNode()|ROOT\\0623-add-one-row-to-tree.cpp\\addOneRow(TreeNode*,int,int)\\root\\AKA_VECTOR_INIT_root_0\\root\\TreeNode()");AKA_fCall++;auto AKA_VECTOR_INIT_root_0 = new ::TreeNode();
/* NormalNumberDataNode val */
(*AKA_VECTOR_INIT_root_0).val=-430135383;
...
int root1_x=-416194092;
/* PointerStructureDataNode left */
TreeNode* root1_left;
/* PointerStructureDataNode right */
TreeNode* root1_right;
AKA_mark("Calling: .\\p6\\0623-add-one-row-to-tree\\0623-add-one-row-to-tree.cpp\\TreeNode\\TreeNode(int,TreeNode*,TreeNode*)|ROOT\\0623-add-one-row-to-tree.cpp\\addOneRow(TreeNode*,int,int)\\root\\AKA_VECTOR_INIT_root_1\\root\\TreeNode(int,TreeNode*,TreeNode*)");AKA_fCall++;auto AKA_VECTOR_INIT_root_1 = new ::TreeNode(root1_x,root1_left,root1_right);
/* NormalNumberDataNode val */
(*AKA_VECTOR_INIT_root_1).val=1411378592;
/* PointerStructureDataNode left */
...
/* NormalNumberDataNode x */
int root2_x=0;
AKA_mark("Calling: .\\p6\\0623-add-one-row-to-tree\\0623-add-one-row-to-tree.cpp\\TreeNode\\TreeNode(int)|ROOT\\0623-add-one-row-to-tree.cpp\\addOneRow(TreeNode*,int,int)\\root\\AKA_VECTOR_INIT_root_2\\root\\TreeNode(int)");AKA_fCall++;auto AKA_VECTOR_INIT_root_2 = new ::TreeNode(root2_x);
/* NormalNumberDataNode val */
...
AKA_mark("<<PRE-CALLING>> Test Solution_addOneRow_TreeNodemul_int_int_random_4");TreeNode* AKA_ACTUAL_OUTPUT=AKA_INSTANCE___Solution->addOneRow(root,val,d);
AKA_fCall++;AKA_mark("Return from: .\\p6\\0623-add-one-row-to-tree\\0623-add-one-row-to-tree.cpp\\Solution\\addOneRow(TreeNode*,int,int)");
...
int main()
{
    ...
    /* add & run the tests */
	AKA_run_test("SOLUTION_ADDONEROW_TREENODEMUL_INT_INT_RANDOM_4", &AKA_TEST_Solution_addOneRow_TreeNodemul_int_int_random_4, 1);
