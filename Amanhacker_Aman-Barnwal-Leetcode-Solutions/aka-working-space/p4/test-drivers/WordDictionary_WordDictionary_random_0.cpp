...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p4\\test-paths\\WordDictionary_WordDictionary_random_0.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p4\\execution-results\\WordDictionary_WordDictionary_random_0.trc"
...
#include "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p4\\instruments\0211-design-add-and-search-words-data-structure\0211-design-add-and-search-words-data-structure.akaignore.cpp"
/** Guard statement to avoid multiple declaration */
#ifndef AKA_GLOBAL_AKA_INSTANCE___WordDictionary
#define AKA_GLOBAL_AKA_INSTANCE___WordDictionary
::WordDictionary* AKA_INSTANCE___WordDictionary;
#endif
...
void AKA_TEST_WordDictionary_WordDictionary_random_0(void) {
{
AKA_test_case_name="WordDictionary_WordDictionary_random_0";
...
/* SubClassDataNode AKA_INSTANCE___WordDictionary */
/* ConstructorDataNode WordDictionary() */
AKA_mark("<<PRE-CALLING>>");AKA_mark("Calling: .\\p4\\0211-design-add-and-search-words-data-structure\\0211-design-add-and-search-words-data-structure.cpp\\WordDictionary\\WordDictionary()|ROOT\\0211-design-add-and-search-words-data-structure.cpp\\GLOBAL\\AKA_INSTANCE___WordDictionary\\AKA_INSTANCE___WordDictionary\\WordDictionary()");AKA_fCall++;auto EXPECTED_AKA_GLOBAL_AKA_INSTANCE___WordDictionary = new ::WordDictionary();
/* VectorDataNode v */
...
int main()
{
    ...
    /* add & run the tests */
	AKA_run_test("WORDDICTIONARY_WORDDICTIONARY_RANDOM_0", &AKA_TEST_WordDictionary_WordDictionary_random_0, 1);
