...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p2\\test-paths\\Node_Node_int_random_0.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p2\\execution-results\\Node_Node_int_random_0.trc"
...
int AKA_INSTANCE___Node__val=547620883;
AKA_mark("<<PRE-CALLING>> Test Node_Node_int_random_0");AKA_mark("Calling: .\\p2\\0116-populating-next-right-pointers-in-each-node\\0116-populating-next-right-pointers-in-each-node.cpp\\Node\\Node(int)|ROOT\\0116-populating-next-right-pointers-in-each-node.cpp\\GLOBAL\\AKA_INSTANCE___Node\\AKA_INSTANCE___Node\\Node(int)");AKA_fCall++;AKA_INSTANCE___Node = new ::Node(AKA_INSTANCE___Node__val);
