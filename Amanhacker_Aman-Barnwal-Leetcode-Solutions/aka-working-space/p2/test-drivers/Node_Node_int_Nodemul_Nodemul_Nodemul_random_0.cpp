...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p2\\test-paths\\Node_Node_int_Nodemul_Nodemul_Nodemul_random_0.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p2\\execution-results\\Node_Node_int_Nodemul_Nodemul_Nodemul_random_0.trc"
...
#include "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p2\\instruments\0116-populating-next-right-pointers-in-each-node\0116-populating-next-right-pointers-in-each-node.akaignore.cpp"
...
int AKA_INSTANCE___Node__val=518437990;
...
AKA_mark("Calling: .\\p2\\0116-populating-next-right-pointers-in-each-node\\0116-populating-next-right-pointers-in-each-node.cpp\\Node\\Node()|ROOT\\0116-populating-next-right-pointers-in-each-node.cpp\\GLOBAL\\AKA_INSTANCE___Node\\AKA_INSTANCE___Node\\Node(int,Node*,Node*,Node*)\\_left\\_left[0]\\_left\\Node()");AKA_fCall++;auto AKA_VECTOR_INIT_AKA_INSTANCE___Node__left_0 = new ::Node();
...
/* SubClassDataNode _left */
/* ConstructorDataNode Node() */
AKA_mark("Calling: .\\p2\\0116-populating-next-right-pointers-in-each-node\\0116-populating-next-right-pointers-in-each-node.cpp\\Node\\Node()|ROOT\\0116-populating-next-right-pointers-in-each-node.cpp\\GLOBAL\\AKA_INSTANCE___Node\\AKA_INSTANCE___Node\\Node(int,Node*,Node*,Node*)\\_left\\_left[1]\\_left\\Node()");AKA_fCall++;auto AKA_VECTOR_INIT_AKA_INSTANCE___Node__left_1 = new ::Node();
/* NormalNumberDataNode val */
/* val : null value -> no code */
/* PointerStructureDataNode left */
...
AKA_mark("<<PRE-CALLING>> Test Node_Node_int_Nodemul_Nodemul_Nodemul_random_0");AKA_mark("Calling: .\\p2\\0116-populating-next-right-pointers-in-each-node\\0116-populating-next-right-pointers-in-each-node.cpp\\Node\\Node(int,Node*,Node*,Node*)|ROOT\\0116-populating-next-right-pointers-in-each-node.cpp\\GLOBAL\\AKA_INSTANCE___Node\\AKA_INSTANCE___Node\\Node(int,Node*,Node*,Node*)");AKA_fCall++;AKA_INSTANCE___Node = new ::Node(AKA_INSTANCE___Node__val,AKA_INSTANCE___Node__left,AKA_INSTANCE___Node__right,AKA_INSTANCE___Node__next);
/* NormalNumberDataNode val */
/* val : null value -> no code */
/* PointerStructureDataNode left */
