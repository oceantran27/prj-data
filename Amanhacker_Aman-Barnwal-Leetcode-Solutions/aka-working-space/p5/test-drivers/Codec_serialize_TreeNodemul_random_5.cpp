...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p5\\test-paths\\Codec_serialize_TreeNodemul_random_5.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p5\\execution-results\\Codec_serialize_TreeNodemul_random_5.trc"
...
void AKA_TEST_Codec_serialize_TreeNodemul_random_5(void) {
{
AKA_test_case_name="Codec_serialize_TreeNodemul_random_5";
...
int root0_x=51552430;
AKA_mark("Calling: .\\p5\\0449-serialize-and-deserialize-bst\\0449-serialize-and-deserialize-bst.cpp\\TreeNode\\TreeNode(int)|ROOT\\0449-serialize-and-deserialize-bst.cpp\\serialize(TreeNode*)\\root\\AKA_VECTOR_INIT_root_0\\root\\TreeNode(int)");AKA_fCall++;auto AKA_VECTOR_INIT_root_0 = new ::TreeNode(root0_x);
...
/* ConstructorDataNode TreeNode(int) */
/* NormalNumberDataNode x */
int root1_x=885225894;
AKA_mark("Calling: .\\p5\\0449-serialize-and-deserialize-bst\\0449-serialize-and-deserialize-bst.cpp\\TreeNode\\TreeNode(int)|ROOT\\0449-serialize-and-deserialize-bst.cpp\\serialize(TreeNode*)\\root\\AKA_VECTOR_INIT_root_1\\root\\TreeNode(int)");AKA_fCall++;auto AKA_VECTOR_INIT_root_1 = new ::TreeNode(root1_x);
/* NormalNumberDataNode val */
/* val : null value -> no code */
/* PointerStructureDataNode left */
...
AKA_mark("<<PRE-CALLING>> Test Codec_serialize_TreeNodemul_random_5");string AKA_ACTUAL_OUTPUT=AKA_INSTANCE___Codec->serialize(root);
AKA_fCall++;AKA_mark("Return from: .\\p5\\0449-serialize-and-deserialize-bst\\0449-serialize-and-deserialize-bst.cpp\\Codec\\serialize(TreeNode*)");
...
int main()
{
    ...
    /* add & run the tests */
	AKA_run_test("CODEC_SERIALIZE_TREENODEMUL_RANDOM_5", &AKA_TEST_Codec_serialize_TreeNodemul_random_5, 1);
