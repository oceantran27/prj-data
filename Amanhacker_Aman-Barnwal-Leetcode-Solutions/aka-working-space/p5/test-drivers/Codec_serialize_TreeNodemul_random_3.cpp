...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p5\\test-paths\\Codec_serialize_TreeNodemul_random_3.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p5\\execution-results\\Codec_serialize_TreeNodemul_random_3.trc"
...
void AKA_TEST_Codec_serialize_TreeNodemul_random_3(void) {
{
AKA_test_case_name="Codec_serialize_TreeNodemul_random_3";
...
AKA_mark("<<PRE-CALLING>> Test Codec_serialize_TreeNodemul_random_3");string AKA_ACTUAL_OUTPUT=AKA_INSTANCE___Codec->serialize(root);
...
int main()
{
    ...
    /* add & run the tests */
	AKA_run_test("CODEC_SERIALIZE_TREENODEMUL_RANDOM_3", &AKA_TEST_Codec_serialize_TreeNodemul_random_3, 1);
