...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p5\\test-paths\\Solution_addNodeAtBeginning_ListNodemulmul_int_random_3.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p5\\execution-results\\Solution_addNodeAtBeginning_ListNodemulmul_int_random_3.trc"
...
void AKA_TEST_Solution_addNodeAtBeginning_ListNodemulmul_int_random_3(void) {
{
AKA_test_case_name="Solution_addNodeAtBeginning_ListNodemulmul_int_random_3";
...
AKA_mark("<<PRE-CALLING>> Test Solution_addNodeAtBeginning_ListNodemulmul_int_random_3");AKA_INSTANCE___Solution->addNodeAtBeginning(head,val);
AKA_fCall++;AKA_mark("Return from: .\\p5\\0445-add-two-numbers-ii\\0445-add-two-numbers-ii.cpp\\Solution\\addNodeAtBeginning(ListNode**,int)");
...
int main()
{
    ...
    /* add & run the tests */
	AKA_run_test("SOLUTION_ADDNODEATBEGINNING_LISTNODEMULMUL_INT_RANDOM_3", &AKA_TEST_Solution_addNodeAtBeginning_ListNodemulmul_int_random_3, 1);
