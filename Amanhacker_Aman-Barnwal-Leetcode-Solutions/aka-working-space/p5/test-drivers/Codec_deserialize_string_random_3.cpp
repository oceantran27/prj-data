...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p5\\test-paths\\Codec_deserialize_string_random_3.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p5\\execution-results\\Codec_deserialize_string_random_3.trc"
...
void AKA_TEST_Codec_deserialize_string_random_3(void) {
{
AKA_test_case_name="Codec_deserialize_string_random_3";
...
char* akaRandomName272489 = new char[2];akaRandomName272489[0] = 90;akaRandomName272489[1] = '\0';string data=akaRandomName272489;
...
AKA_mark("<<PRE-CALLING>> Test Codec_deserialize_string_random_3");TreeNode* AKA_ACTUAL_OUTPUT=AKA_INSTANCE___Codec->deserialize(data);
AKA_fCall++;AKA_mark("Return from: .\\p5\\0449-serialize-and-deserialize-bst\\0449-serialize-and-deserialize-bst.cpp\\Codec\\deserialize(string)");
...
int main()
{
    ...
    /* add & run the tests */
	AKA_run_test("CODEC_DESERIALIZE_STRING_RANDOM_3", &AKA_TEST_Codec_deserialize_string_random_3, 1);
