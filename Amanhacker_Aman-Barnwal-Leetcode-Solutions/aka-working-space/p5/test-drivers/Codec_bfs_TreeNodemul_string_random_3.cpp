...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p5\\test-paths\\Codec_bfs_TreeNodemul_string_random_3.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p5\\execution-results\\Codec_bfs_TreeNodemul_string_random_3.trc"
...
void AKA_TEST_Codec_bfs_TreeNodemul_string_random_3(void) {
{
AKA_test_case_name="Codec_bfs_TreeNodemul_string_random_3";
...
char* akaRandomName274466 = new char[2];akaRandomName274466[0] = 50;akaRandomName274466[1] = '\0';string res=akaRandomName274466;
...
AKA_mark("<<PRE-CALLING>> Test Codec_bfs_TreeNodemul_string_random_3");AKA_INSTANCE___Codec->bfs(root,res);
...
int main()
{
    ...
    /* add & run the tests */
	AKA_run_test("CODEC_BFS_TREENODEMUL_STRING_RANDOM_3", &AKA_TEST_Codec_bfs_TreeNodemul_string_random_3, 1);
