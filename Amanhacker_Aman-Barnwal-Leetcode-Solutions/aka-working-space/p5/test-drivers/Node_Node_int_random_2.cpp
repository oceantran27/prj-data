...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p5\\test-paths\\Node_Node_int_random_2.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p5\\execution-results\\Node_Node_int_random_2.trc"
...
void AKA_TEST_Node_Node_int_random_2(void) {
{
AKA_test_case_name="Node_Node_int_random_2";
...
int AKA_INSTANCE___Node__val=-88780647;
AKA_mark("<<PRE-CALLING>> Test Node_Node_int_random_2");AKA_mark("Calling: .\\p5\\0429-n-ary-tree-level-order-traversal\\0429-n-ary-tree-level-order-traversal.cpp\\Node\\Node(int)|ROOT\\0429-n-ary-tree-level-order-traversal.cpp\\GLOBAL\\AKA_INSTANCE___Node\\AKA_INSTANCE___Node\\Node(int)");AKA_fCall++;AKA_INSTANCE___Node = new ::Node(AKA_INSTANCE___Node__val);
/* NormalNumberDataNode val */
AKA_INSTANCE___Node->val=-1611878905;
...
int main()
{
    ...
    /* add & run the tests */
	AKA_run_test("NODE_NODE_INT_RANDOM_2", &AKA_TEST_Node_Node_int_random_2, 1);
