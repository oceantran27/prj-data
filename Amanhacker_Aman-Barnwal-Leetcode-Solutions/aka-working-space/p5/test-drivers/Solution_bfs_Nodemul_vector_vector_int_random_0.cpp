...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p5\\test-paths\\Solution_bfs_Nodemul_vector_vector_int_random_0.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p5\\execution-results\\Solution_bfs_Nodemul_vector_vector_int_random_0.trc"
...
void AKA_TEST_Solution_bfs_Nodemul_vector_vector_int_random_0(void) {
{
AKA_test_case_name="Solution_bfs_Nodemul_vector_vector_int_random_0";
...
int res_element0_element0=-2101885591;
res_element0.push_back(res_element0_element0);
res.push_back(res_element0);
vector<int> res_element1;
int res_element1_element0=-1763835967;
res_element1.push_back(res_element1_element0);
int res_element1_element1=715292902;
res_element1.push_back(res_element1_element1);
int res_element1_element2=1717355460;
res_element1.push_back(res_element1_element2);
res.push_back(res_element1);
vector<int> res_element2;
int res_element2_element0=634945495;
res_element2.push_back(res_element2_element0);
int res_element2_element1=1784783213;
res_element2.push_back(res_element2_element1);
res.push_back(res_element2);



AKA_mark("<<PRE-CALLING>> Test Solution_bfs_Nodemul_vector_vector_int_random_0");AKA_INSTANCE___Solution->bfs(root,res);
AKA_fCall++;AKA_mark("Return from: .\\p5\\0429-n-ary-tree-level-order-traversal\\0429-n-ary-tree-level-order-traversal.cpp\\Solution\\bfs(Node*,vector<vector<int>>&)");
...
int main()
{
    ...
    /* add & run the tests */
	AKA_run_test("SOLUTION_BFS_NODEMUL_VECTOR_VECTOR_INT_RANDOM_0", &AKA_TEST_Solution_bfs_Nodemul_vector_vector_int_random_0, 1);
