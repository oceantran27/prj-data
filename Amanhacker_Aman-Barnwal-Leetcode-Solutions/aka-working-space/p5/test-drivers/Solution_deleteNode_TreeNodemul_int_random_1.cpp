...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p5\\test-paths\\Solution_deleteNode_TreeNodemul_int_random_1.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p5\\execution-results\\Solution_deleteNode_TreeNodemul_int_random_1.trc"
...
void AKA_TEST_Solution_deleteNode_TreeNodemul_int_random_1(void) {
{
AKA_test_case_name="Solution_deleteNode_TreeNodemul_int_random_1";
...
AKA_mark("<<PRE-CALLING>> Test Solution_deleteNode_TreeNodemul_int_random_1");TreeNode* AKA_ACTUAL_OUTPUT=AKA_INSTANCE___Solution->deleteNode(root,key);
...
int main()
{
    ...
    /* add & run the tests */
	AKA_run_test("SOLUTION_DELETENODE_TREENODEMUL_INT_RANDOM_1", &AKA_TEST_Solution_deleteNode_TreeNodemul_int_random_1, 1);
