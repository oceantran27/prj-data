...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p5\\test-paths\\Solution_findAnagrams_string_string_random_0.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p5\\execution-results\\Solution_findAnagrams_string_string_random_0.trc"
...
#include "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p5\\instruments\0438-find-all-anagrams-in-a-string\0438-find-all-anagrams-in-a-string.akaignore.cpp"
...
void AKA_TEST_Solution_findAnagrams_string_string_random_0(void) {
{
AKA_test_case_name="Solution_findAnagrams_string_string_random_0";
...
AKA_mark("Calling: \\Solution()|ROOT\\0438-find-all-anagrams-in-a-string.cpp\\GLOBAL\\AKA_INSTANCE___Solution\\AKA_INSTANCE___Solution\\Solution()");AKA_fCall++;AKA_INSTANCE___Solution = new ::Solution();


char* akaRandomName672803 = new char[2];akaRandomName672803[0] = 74;akaRandomName672803[1] = '\0';string txt=akaRandomName672803;
char* akaRandomName65469 = new char[2];akaRandomName65469[0] = -127;akaRandomName65469[1] = '\0';string pat=akaRandomName65469;
vector<int> AKA_EXPECTED_OUTPUT;

/* RootDataNode STATIC */
/* NormalStringDataNode txt */
/* NormalStringDataNode pat */
/* VectorDataNode RETURN */



AKA_mark("<<PRE-CALLING>> Test Solution_findAnagrams_string_string_random_0");vector<int> AKA_ACTUAL_OUTPUT=AKA_INSTANCE___Solution->findAnagrams(txt,pat);
AKA_fCall++;AKA_mark("Return from: .\\p5\\0438-find-all-anagrams-in-a-string\\0438-find-all-anagrams-in-a-string.cpp\\Solution\\findAnagrams(string,string)");
...
int main()
{
    ...
    /* add & run the tests */
	AKA_run_test("SOLUTION_FINDANAGRAMS_STRING_STRING_RANDOM_0", &AKA_TEST_Solution_findAnagrams_string_string_random_0, 1);
