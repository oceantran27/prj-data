...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p5\\test-paths\\TreeNode_int_random_3.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p5\\execution-results\\TreeNode_int_random_3.trc"
...
void AKA_TEST_TreeNode_int_random_3(void) {
{
...
int AKA_INSTANCE___TreeNode_x=876898267;
AKA_mark("<<PRE-CALLING>> Test TreeNode_int_random_3");AKA_mark("Calling: .\\p5\\0449-serialize-and-deserialize-bst\\0449-serialize-and-deserialize-bst.cpp\\TreeNode\\TreeNode(int)|ROOT\\0449-serialize-and-deserialize-bst.cpp\\GLOBAL\\AKA_INSTANCE___TreeNode\\AKA_INSTANCE___TreeNode\\TreeNode(int)");AKA_fCall++;AKA_INSTANCE___TreeNode = new ::TreeNode(AKA_INSTANCE___TreeNode_x);
...
int main()
{
    ...
    /* add & run the tests */
	AKA_run_test("TREENODE_INT_RANDOM_3", &AKA_TEST_TreeNode_int_random_3, 1);
