...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p3\\test-paths\\Solution_bfs_Nodemul_random_2.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p3\\execution-results\\Solution_bfs_Nodemul_random_2.trc"
...
void AKA_TEST_Solution_bfs_Nodemul_random_2(void) {
{
...
AKA_mark("Calling: .\\p3\\0117-populating-next-right-pointers-in-each-node-ii\\0117-populating-next-right-pointers-in-each-node-ii.cpp\\Node\\Node()|ROOT\\0117-populating-next-right-pointers-in-each-node-ii.cpp\\bfs(Node*&)\\root\\AKA_VECTOR_INIT_root_0\\root\\Node()");AKA_fCall++;auto AKA_VECTOR_INIT_root_0 = new ::Node();
...
int main()
{
    ...
    /* add & run the tests */
	AKA_run_test("SOLUTION_BFS_NODEMUL_RANDOM_2", &AKA_TEST_Solution_bfs_Nodemul_random_2, 1);
