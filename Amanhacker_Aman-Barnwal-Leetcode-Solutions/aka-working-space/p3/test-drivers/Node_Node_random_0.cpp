...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p3\\test-paths\\Node_Node_random_0.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p3\\execution-results\\Node_Node_random_0.trc"
...
void AKA_TEST_Node_Node_random_0(void) {
{
AKA_test_case_name="Node_Node_random_0";
...
AKA_mark("<<PRE-CALLING>> Test Node_Node_random_0");AKA_mark("Calling: .\\p3\\0117-populating-next-right-pointers-in-each-node-ii\\0117-populating-next-right-pointers-in-each-node-ii.cpp\\Node\\Node()|ROOT\\0117-populating-next-right-pointers-in-each-node-ii.cpp\\GLOBAL\\AKA_INSTANCE___Node\\AKA_INSTANCE___Node\\Node()");AKA_fCall++;AKA_INSTANCE___Node = new ::Node();
...
/* SubClassDataNode AKA_INSTANCE___Node */
/* ConstructorDataNode Node() */
AKA_mark("<<PRE-CALLING>>");AKA_mark("Calling: .\\p3\\0117-populating-next-right-pointers-in-each-node-ii\\0117-populating-next-right-pointers-in-each-node-ii.cpp\\Node\\Node()|ROOT\\0117-populating-next-right-pointers-in-each-node-ii.cpp\\GLOBAL\\AKA_INSTANCE___Node\\AKA_INSTANCE___Node\\Node()");AKA_fCall++;auto EXPECTED_AKA_GLOBAL_AKA_INSTANCE___Node = new ::Node();
/* NormalNumberDataNode val */
/* val : null value -> no code */
/* PointerStructureDataNode left */
EXPECTED_AKA_GLOBAL_AKA_INSTANCE___Node->left;
/* PointerStructureDataNode right */
EXPECTED_AKA_GLOBAL_AKA_INSTANCE___Node->right;
/* PointerStructureDataNode next */
EXPECTED_AKA_GLOBAL_AKA_INSTANCE___Node->next;
...
int main()
{
    ...
    /* add & run the tests */
	AKA_run_test("NODE_NODE_RANDOM_0", &AKA_TEST_Node_Node_random_0, 1);
