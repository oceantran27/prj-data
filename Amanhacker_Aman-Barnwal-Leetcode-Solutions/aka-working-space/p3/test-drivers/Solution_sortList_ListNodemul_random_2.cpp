...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p3\\test-paths\\Solution_sortList_ListNodemul_random_2.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p3\\execution-results\\Solution_sortList_ListNodemul_random_2.trc"
...
void AKA_TEST_Solution_sortList_ListNodemul_random_2(void) {
{
AKA_test_case_name="Solution_sortList_ListNodemul_random_2";
...
int head0_x=1053426070;
AKA_mark("Calling: .\\p3\\0148-sort-list\\0148-sort-list.cpp\\ListNode\\ListNode(int)|ROOT\\0148-sort-list.cpp\\sortList(ListNode*)\\head\\AKA_VECTOR_INIT_head_0\\head\\ListNode(int)");AKA_fCall++;auto AKA_VECTOR_INIT_head_0 = new ::ListNode(head0_x);
...
AKA_mark("Calling: .\\p3\\0148-sort-list\\0148-sort-list.cpp\\ListNode\\ListNode()|ROOT\\0148-sort-list.cpp\\sortList(ListNode*)\\head\\AKA_VECTOR_INIT_head_0\\head\\next\\next[0]\\next\\ListNode()");AKA_fCall++;auto AKA_VECTOR_INIT_head_0_DOT_next_0 = new ::ListNode();
/* NormalNumberDataNode val */
/* val : null value -> no code */
/* PointerStructureDataNode next */
...
/* ConstructorDataNode ListNode(int) */
/* NormalNumberDataNode x */
int head1_x=1152544781;
AKA_mark("Calling: .\\p3\\0148-sort-list\\0148-sort-list.cpp\\ListNode\\ListNode(int)|ROOT\\0148-sort-list.cpp\\sortList(ListNode*)\\head\\AKA_VECTOR_INIT_head_1\\head\\ListNode(int)");AKA_fCall++;auto AKA_VECTOR_INIT_head_1 = new ::ListNode(head1_x);
/* NormalNumberDataNode val */
/* val : null value -> no code */
/* PointerStructureDataNode next */
...
AKA_mark("<<PRE-CALLING>> Test Solution_sortList_ListNodemul_random_2");ListNode* AKA_ACTUAL_OUTPUT=AKA_INSTANCE___Solution->sortList(head);
AKA_fCall++;AKA_mark("Return from: .\\p3\\0148-sort-list\\0148-sort-list.cpp\\Solution\\sortList(ListNode*)");
...
int main()
{
    ...
    /* add & run the tests */
	AKA_run_test("SOLUTION_SORTLIST_LISTNODEMUL_RANDOM_2", &AKA_TEST_Solution_sortList_ListNodemul_random_2, 1);
