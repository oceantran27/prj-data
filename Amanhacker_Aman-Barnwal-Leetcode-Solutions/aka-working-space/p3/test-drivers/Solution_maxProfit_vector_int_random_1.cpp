...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p3\\test-paths\\Solution_maxProfit_vector_int_random_1.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p3\\execution-results\\Solution_maxProfit_vector_int_random_1.trc"
...
#include "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p3\\instruments\0121-best-time-to-buy-and-sell-stock\0121-best-time-to-buy-and-sell-stock.akaignore.cpp"
...
void AKA_TEST_Solution_maxProfit_vector_int_random_1(void) {
{
...
AKA_mark("Calling: \\Solution()|ROOT\\0121-best-time-to-buy-and-sell-stock.cpp\\GLOBAL\\AKA_INSTANCE___Solution\\AKA_INSTANCE___Solution\\Solution()");AKA_fCall++;AKA_INSTANCE___Solution = new ::Solution();
...
int prices_element0=-1396478747;
prices.push_back(prices_element0);
int prices_element1=1560948937;
...
AKA_fCall++;AKA_mark("Return from: .\\p3\\0121-best-time-to-buy-and-sell-stock\\0121-best-time-to-buy-and-sell-stock.cpp\\Solution\\maxProfit(vector<int>&)");
...
int main()
{
    ...
    /* add & run the tests */
	AKA_run_test("SOLUTION_MAXPROFIT_VECTOR_INT_RANDOM_1", &AKA_TEST_Solution_maxProfit_vector_int_random_1, 1);
