...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p11v1\\test-paths\\TreeNode_int_random_1.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p11v1\\execution-results\\TreeNode_int_random_1.trc"
...
void AKA_TEST_TreeNode_int_random_1(void) {
{
...
int AKA_INSTANCE___TreeNode_x=1214377454;
AKA_mark("<<PRE-CALLING>> Test TreeNode_int_random_1");AKA_mark("Calling: .\\p11\\103-binary-tree-zigzag-level-order-traversal\\103-binary-tree-zigzag-level-order-traversal.cpp\\TreeNode\\TreeNode(int)|ROOT\\103-binary-tree-zigzag-level-order-traversal.cpp\\GLOBAL\\AKA_INSTANCE___TreeNode\\AKA_INSTANCE___TreeNode\\TreeNode(int)");AKA_fCall++;AKA_INSTANCE___TreeNode = new ::TreeNode(AKA_INSTANCE___TreeNode_x);
...
int main()
{
    ...
    /* add & run the tests */
	AKA_run_test("TREENODE_INT_RANDOM_1", &AKA_TEST_TreeNode_int_random_1, 1);
