...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p1\\test-paths\\Solution_deleteDuplicates_ListNodemul_random_0.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p1\\execution-results\\Solution_deleteDuplicates_ListNodemul_random_0.trc"
...
void AKA_TEST_Solution_deleteDuplicates_ListNodemul_random_0(void) {
{
...
AKA_mark("Calling: \\Solution()|ROOT\\0082-remove-duplicates-from-sorted-list-ii.cpp\\GLOBAL\\AKA_INSTANCE___Solution\\AKA_INSTANCE___Solution\\Solution()");AKA_fCall++;AKA_INSTANCE___Solution = new ::Solution();
...
int head0_x=-562694030;
/* PointerStructureDataNode next */
ListNode* head0_next;
AKA_mark("Calling: .\\p1\\0082-remove-duplicates-from-sorted-list-ii\\0082-remove-duplicates-from-sorted-list-ii.cpp\\ListNode\\ListNode(int,ListNode*)|ROOT\\0082-remove-duplicates-from-sorted-list-ii.cpp\\deleteDuplicates(ListNode*)\\head\\AKA_VECTOR_INIT_head_0\\head\\ListNode(int,ListNode*)");AKA_fCall++;auto AKA_VECTOR_INIT_head_0 = new ::ListNode(head0_x,head0_next);
...
AKA_mark("Calling: .\\p1\\0082-remove-duplicates-from-sorted-list-ii\\0082-remove-duplicates-from-sorted-list-ii.cpp\\ListNode\\ListNode()|ROOT\\0082-remove-duplicates-from-sorted-list-ii.cpp\\deleteDuplicates(ListNode*)\\head\\AKA_VECTOR_INIT_head_1\\head\\ListNode()");AKA_fCall++;auto AKA_VECTOR_INIT_head_1 = new ::ListNode();
/* NormalNumberDataNode val */
/* val : null value -> no code */
/* PointerStructureDataNode next */
...
/* NormalNumberDataNode x */
int head2_x=0;
AKA_mark("Calling: .\\p1\\0082-remove-duplicates-from-sorted-list-ii\\0082-remove-duplicates-from-sorted-list-ii.cpp\\ListNode\\ListNode(int)|ROOT\\0082-remove-duplicates-from-sorted-list-ii.cpp\\deleteDuplicates(ListNode*)\\head\\AKA_VECTOR_INIT_head_2\\head\\ListNode(int)");AKA_fCall++;auto AKA_VECTOR_INIT_head_2 = new ::ListNode(head2_x);
/* NormalNumberDataNode val */
/* val : null value -> no code */
/* PointerStructureDataNode next */
...
AKA_fCall++;AKA_mark("Return from: .\\p1\\0082-remove-duplicates-from-sorted-list-ii\\0082-remove-duplicates-from-sorted-list-ii.cpp\\Solution\\deleteDuplicates(ListNode*)");
...
int main()
{
    ...
    /* add & run the tests */
	AKA_run_test("SOLUTION_DELETEDUPLICATES_LISTNODEMUL_RANDOM_0", &AKA_TEST_Solution_deleteDuplicates_ListNodemul_random_0, 1);
