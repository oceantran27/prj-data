...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p1\\test-paths\\Solution_longestPalindrome_string_random_1.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p1\\execution-results\\Solution_longestPalindrome_string_random_1.trc"
...
#include "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p1\\instruments\0005-longest-palindromic-substring\0005-longest-palindromic-substring.akaignore.cpp"
...
void AKA_TEST_Solution_longestPalindrome_string_random_1(void) {
{
AKA_test_case_name="Solution_longestPalindrome_string_random_1";
...
AKA_mark("Calling: \\Solution()|ROOT\\0005-longest-palindromic-substring.cpp\\GLOBAL\\AKA_INSTANCE___Solution\\AKA_INSTANCE___Solution\\Solution()");AKA_fCall++;AKA_INSTANCE___Solution = new ::Solution();


char* akaRandomName746049 = new char[2];akaRandomName746049[0] = -21;akaRandomName746049[1] = '\0';string s=akaRandomName746049;
...
AKA_mark("<<PRE-CALLING>> Test Solution_longestPalindrome_string_random_1");string AKA_ACTUAL_OUTPUT=AKA_INSTANCE___Solution->longestPalindrome(s);
AKA_fCall++;AKA_mark("Return from: .\\p1\\0005-longest-palindromic-substring\\0005-longest-palindromic-substring.cpp\\Solution\\longestPalindrome(string)");
...
int main()
{
    ...
    /* add & run the tests */
	AKA_run_test("SOLUTION_LONGESTPALINDROME_STRING_RANDOM_1", &AKA_TEST_Solution_longestPalindrome_string_random_1, 1);
