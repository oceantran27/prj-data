...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p1\\test-paths\\ListNode_int_random_0.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p1\\execution-results\\ListNode_int_random_0.trc"
...
void AKA_TEST_ListNode_int_random_0(void) {
{
...
int AKA_INSTANCE___ListNode_x=-2056750083;
AKA_mark("<<PRE-CALLING>> Test ListNode_int_random_0");AKA_mark("Calling: .\\p1\\0082-remove-duplicates-from-sorted-list-ii\\0082-remove-duplicates-from-sorted-list-ii.cpp\\ListNode\\ListNode(int)|ROOT\\0082-remove-duplicates-from-sorted-list-ii.cpp\\GLOBAL\\AKA_INSTANCE___ListNode\\AKA_INSTANCE___ListNode\\ListNode(int)");AKA_fCall++;AKA_INSTANCE___ListNode = new ::ListNode(AKA_INSTANCE___ListNode_x);
...
int main()
{
    ...
    /* add & run the tests */
	AKA_run_test("LISTNODE_INT_RANDOM_0", &AKA_TEST_ListNode_int_random_0, 1);
