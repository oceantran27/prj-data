...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p1\\test-paths\\ListNode_random_0.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p1\\execution-results\\ListNode_random_0.trc"
...
void AKA_TEST_ListNode_random_0(void) {
{
AKA_test_case_name="ListNode_random_0";
...
AKA_mark("<<PRE-CALLING>> Test ListNode_random_0");AKA_mark("Calling: .\\p1\\0082-remove-duplicates-from-sorted-list-ii\\0082-remove-duplicates-from-sorted-list-ii.cpp\\ListNode\\ListNode()|ROOT\\0082-remove-duplicates-from-sorted-list-ii.cpp\\GLOBAL\\AKA_INSTANCE___ListNode\\AKA_INSTANCE___ListNode\\ListNode()");AKA_fCall++;AKA_INSTANCE___ListNode = new ::ListNode();
...
/* SubStructDataNode AKA_INSTANCE___ListNode */
/* ConstructorDataNode ListNode() */
AKA_mark("<<PRE-CALLING>>");AKA_mark("Calling: .\\p1\\0082-remove-duplicates-from-sorted-list-ii\\0082-remove-duplicates-from-sorted-list-ii.cpp\\ListNode\\ListNode()|ROOT\\0082-remove-duplicates-from-sorted-list-ii.cpp\\GLOBAL\\AKA_INSTANCE___ListNode\\AKA_INSTANCE___ListNode\\ListNode()");AKA_fCall++;auto EXPECTED_AKA_GLOBAL_AKA_INSTANCE___ListNode = new ::ListNode();
/* NormalNumberDataNode val */
/* val : null value -> no code */
/* PointerStructureDataNode next */
EXPECTED_AKA_GLOBAL_AKA_INSTANCE___ListNode->next;
...
int main()
{
    ...
    /* add & run the tests */
	AKA_run_test("LISTNODE_RANDOM_0", &AKA_TEST_ListNode_random_0, 1);
