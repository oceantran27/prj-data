...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p1\\test-paths\\Solution_knapsackHelper_int_int_int_int_random_0.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p1\\execution-results\\Solution_knapsackHelper_int_int_int_int_random_0.trc"
...
#include "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p1\\instruments\0 - 1 Knapsack Problem - GFG\0-1-knapsack-problem.akaignore.cpp"
...
void AKA_TEST_Solution_knapsackHelper_int_int_int_int_random_0(void) {
{
AKA_test_case_name="Solution_knapsackHelper_int_int_int_int_random_0";
...
AKA_mark("Calling: \\Solution()|ROOT\\0-1-knapsack-problem.cpp\\GLOBAL\\AKA_INSTANCE___Solution\\AKA_INSTANCE___Solution\\Solution()");AKA_fCall++;AKA_INSTANCE___Solution = new ::Solution();
...
/* OneDimensionNumberDataNode wt */
/* NormalNumberDataNode wt[0] */
wt[0]=-526999525;
/* NormalNumberDataNode wt[1] */
wt[1]=-1446211684;
/* NormalNumberDataNode wt[2] */
wt[2]=-1305116615;
/* OneDimensionNumberDataNode val */
/* NormalNumberDataNode val[0] */
val[0]=-388918100;
/* NormalNumberDataNode val[1] */
val[1]=1616712528;
/* NormalNumberDataNode val[2] */
val[2]=-993290731;
...
AKA_mark("<<PRE-CALLING>> Test Solution_knapsackHelper_int_int_int_int_random_0");int AKA_ACTUAL_OUTPUT=AKA_INSTANCE___Solution->knapsackHelper(w,wt,val,n);
AKA_fCall++;AKA_mark("Return from: .\\p1\\0 - 1 Knapsack Problem - GFG\\0-1-knapsack-problem.cpp\\Solution\\knapsackHelper(int,int[],int[],int)");
...
int main()
{
    ...
    /* add & run the tests */
	AKA_run_test("SOLUTION_KNAPSACKHELPER_INT_INT_INT_INT_RANDOM_0", &AKA_TEST_Solution_knapsackHelper_int_int_int_int_random_0, 1);
