...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p7\\test-paths\\Solution_dfs_int_unordered_map_int_vector_int_vector_int_vector_int_random_1.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p7\\execution-results\\Solution_dfs_int_unordered_map_int_vector_int_vector_int_vector_int_random_1.trc"
...
void AKA_TEST_Solution_dfs_int_unordered_map_int_vector_int_vector_int_vector_int_random_1(void) {
{
AKA_test_case_name="Solution_dfs_int_unordered_map_int_vector_int_vector_int_vector_int_random_1";
...
AKA_mark("<<PRE-CALLING>> Test Solution_dfs_int_unordered_map_int_vector_int_vector_int_vector_int_random_1");AKA_INSTANCE___Solution->dfs(src,adj,dist,vis);
AKA_fCall++;AKA_mark("Return from: .\\p7\\0863-all-nodes-distance-k-in-binary-tree\\0863-all-nodes-distance-k-in-binary-tree.cpp\\Solution\\dfs(int,unordered_map<int,vector<int>>&,vector<int>&,vector<int>&)");
...
int main()
{
    ...
    /* add & run the tests */
	AKA_run_test("SOLUTION_DFS_INT_UNORDERED_MAP_INT_VECTOR_INT_VECTOR_INT_VECTOR_INT_RANDOM_1", &AKA_TEST_Solution_dfs_int_unordered_map_int_vector_int_vector_int_vector_int_random_1, 1);
