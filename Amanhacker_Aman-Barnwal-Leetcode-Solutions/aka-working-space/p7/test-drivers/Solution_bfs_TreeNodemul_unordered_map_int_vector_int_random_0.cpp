...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p7\\test-paths\\Solution_bfs_TreeNodemul_unordered_map_int_vector_int_random_0.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p7\\execution-results\\Solution_bfs_TreeNodemul_unordered_map_int_vector_int_random_0.trc"
...
void AKA_TEST_Solution_bfs_TreeNodemul_unordered_map_int_vector_int_random_0(void) {
{
AKA_test_case_name="Solution_bfs_TreeNodemul_unordered_map_int_vector_int_random_0";
...
AKA_mark("<<PRE-CALLING>> Test Solution_bfs_TreeNodemul_unordered_map_int_vector_int_random_0");AKA_INSTANCE___Solution->bfs(root,adj);
AKA_fCall++;AKA_mark("Return from: .\\p7\\0863-all-nodes-distance-k-in-binary-tree\\0863-all-nodes-distance-k-in-binary-tree.cpp\\Solution\\bfs(TreeNode*,unordered_map<int,vector<int>>&)");
...
int main()
{
    ...
    /* add & run the tests */
	AKA_run_test("SOLUTION_BFS_TREENODEMUL_UNORDERED_MAP_INT_VECTOR_INT_RANDOM_0", &AKA_TEST_Solution_bfs_TreeNodemul_unordered_map_int_vector_int_random_0, 1);
