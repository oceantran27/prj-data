...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p7\\test-paths\\Solution_bfs_TreeNodemul_vector_TreeNodemul_random_0.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p7\\execution-results\\Solution_bfs_TreeNodemul_vector_TreeNodemul_random_0.trc"
...
void AKA_TEST_Solution_bfs_TreeNodemul_vector_TreeNodemul_random_0(void) {
{
AKA_test_case_name="Solution_bfs_TreeNodemul_vector_TreeNodemul_random_0";
...
AKA_mark("<<PRE-CALLING>> Test Solution_bfs_TreeNodemul_vector_TreeNodemul_random_0");AKA_INSTANCE___Solution->bfs(root,deepest);
AKA_fCall++;AKA_mark("Return from: .\\p7\\0865-smallest-subtree-with-all-the-deepest-nodes\\0865-smallest-subtree-with-all-the-deepest-nodes.cpp\\Solution\\bfs(TreeNode*,vector<TreeNode*>&)");

/* error assertion */
vector<TreeNode*> EXPECTED_deepest;
...
int main()
{
    ...
    /* add & run the tests */
	AKA_run_test("SOLUTION_BFS_TREENODEMUL_VECTOR_TREENODEMUL_RANDOM_0", &AKA_TEST_Solution_bfs_TreeNodemul_vector_TreeNodemul_random_0, 1);
