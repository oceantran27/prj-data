...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p7\\test-paths\\Solution_subtreeWithAllDeepest_TreeNodemul_random_3.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p7\\execution-results\\Solution_subtreeWithAllDeepest_TreeNodemul_random_3.trc"
...
void AKA_TEST_Solution_subtreeWithAllDeepest_TreeNodemul_random_3(void) {
{
AKA_test_case_name="Solution_subtreeWithAllDeepest_TreeNodemul_random_3";
...
AKA_mark("<<PRE-CALLING>> Test Solution_subtreeWithAllDeepest_TreeNodemul_random_3");TreeNode* AKA_ACTUAL_OUTPUT=AKA_INSTANCE___Solution->subtreeWithAllDeepest(root);
AKA_fCall++;AKA_mark("Return from: .\\p7\\0865-smallest-subtree-with-all-the-deepest-nodes\\0865-smallest-subtree-with-all-the-deepest-nodes.cpp\\Solution\\subtreeWithAllDeepest(TreeNode*)");
...
int main()
{
    ...
    /* add & run the tests */
	AKA_run_test("SOLUTION_SUBTREEWITHALLDEEPEST_TREENODEMUL_RANDOM_3", &AKA_TEST_Solution_subtreeWithAllDeepest_TreeNodemul_random_3, 1);
