...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p7\\test-paths\\Solution_pruneHelper_TreeNodemul_random_4.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p7\\execution-results\\Solution_pruneHelper_TreeNodemul_random_4.trc"
...
void AKA_TEST_Solution_pruneHelper_TreeNodemul_random_4(void) {
{
AKA_test_case_name="Solution_pruneHelper_TreeNodemul_random_4";
...
AKA_mark("<<PRE-CALLING>> Test Solution_pruneHelper_TreeNodemul_random_4");bool AKA_ACTUAL_OUTPUT=AKA_INSTANCE___Solution->pruneHelper(root);
AKA_fCall++;AKA_mark("Return from: .\\p7\\0814-binary-tree-pruning\\0814-binary-tree-pruning.cpp\\Solution\\pruneHelper(TreeNode*&)");
...
int main()
{
    ...
    /* add & run the tests */
	AKA_run_test("SOLUTION_PRUNEHELPER_TREENODEMUL_RANDOM_4", &AKA_TEST_Solution_pruneHelper_TreeNodemul_random_4, 1);
