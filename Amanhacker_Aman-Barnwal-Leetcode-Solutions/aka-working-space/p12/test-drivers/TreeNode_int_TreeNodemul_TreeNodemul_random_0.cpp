...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p12\\test-paths\\TreeNode_int_TreeNodemul_TreeNodemul_random_0.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p12\\execution-results\\TreeNode_int_TreeNodemul_TreeNodemul_random_0.trc"
...
#include "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p12\\instruments\105-construct-binary-tree-from-preorder-and-inorder-traversal\105-construct-binary-tree-from-preorder-and-inorder-traversal.akaignore.cpp"
...
int AKA_INSTANCE___TreeNode_x=-999519284;
/* PointerStructureDataNode left */
std::vector<TreeNode*> AKA_VECTOR_INIT_AKA_INSTANCE___TreeNode_left;
/* SubStructDataNode left */
/* ConstructorDataNode TreeNode(int) */
/* NormalNumberDataNode x */
int AKA_INSTANCE___TreeNode_left0_x=83006161;
AKA_mark("Calling: .\\p12\\105-construct-binary-tree-from-preorder-and-inorder-traversal\\105-construct-binary-tree-from-preorder-and-inorder-traversal.cpp\\TreeNode\\TreeNode(int)|ROOT\\105-construct-binary-tree-from-preorder-and-inorder-traversal.cpp\\GLOBAL\\AKA_INSTANCE___TreeNode\\AKA_INSTANCE___TreeNode\\TreeNode(int,TreeNode*,TreeNode*)\\left\\left[0]\\left\\TreeNode(int)");AKA_fCall++;auto AKA_VECTOR_INIT_AKA_INSTANCE___TreeNode_left_0 = new ::TreeNode(AKA_INSTANCE___TreeNode_left0_x);
...
/* ConstructorDataNode TreeNode(int) */
/* NormalNumberDataNode x */
int AKA_INSTANCE___TreeNode_right0_x=-1945174650;
...
AKA_mark("<<PRE-CALLING>> Test TreeNode_int_TreeNodemul_TreeNodemul_random_0");AKA_mark("Calling: .\\p12\\105-construct-binary-tree-from-preorder-and-inorder-traversal\\105-construct-binary-tree-from-preorder-and-inorder-traversal.cpp\\TreeNode\\TreeNode(int,TreeNode*,TreeNode*)|ROOT\\105-construct-binary-tree-from-preorder-and-inorder-traversal.cpp\\GLOBAL\\AKA_INSTANCE___TreeNode\\AKA_INSTANCE___TreeNode\\TreeNode(int,TreeNode*,TreeNode*)");AKA_fCall++;AKA_INSTANCE___TreeNode = new ::TreeNode(AKA_INSTANCE___TreeNode_x,AKA_INSTANCE___TreeNode_left,AKA_INSTANCE___TreeNode_right);
/* NormalNumberDataNode val */
/* val : null value -> no code */
/* PointerStructureDataNode left */
