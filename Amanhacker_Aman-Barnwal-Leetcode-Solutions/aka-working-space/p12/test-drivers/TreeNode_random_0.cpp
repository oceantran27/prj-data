...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p12\\test-paths\\TreeNode_random_0.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p12\\execution-results\\TreeNode_random_0.trc"
...
void AKA_TEST_TreeNode_random_0(void) {
{
...
AKA_mark("<<PRE-CALLING>> Test TreeNode_random_0");AKA_mark("Calling: .\\p12\\105-construct-binary-tree-from-preorder-and-inorder-traversal\\105-construct-binary-tree-from-preorder-and-inorder-traversal.cpp\\TreeNode\\TreeNode()|ROOT\\105-construct-binary-tree-from-preorder-and-inorder-traversal.cpp\\GLOBAL\\AKA_INSTANCE___TreeNode\\AKA_INSTANCE___TreeNode\\TreeNode()");AKA_fCall++;AKA_INSTANCE___TreeNode = new ::TreeNode();
...
/* SubStructDataNode AKA_INSTANCE___TreeNode */
/* ConstructorDataNode TreeNode() */
AKA_mark("<<PRE-CALLING>>");AKA_mark("Calling: .\\p12\\105-construct-binary-tree-from-preorder-and-inorder-traversal\\105-construct-binary-tree-from-preorder-and-inorder-traversal.cpp\\TreeNode\\TreeNode()|ROOT\\105-construct-binary-tree-from-preorder-and-inorder-traversal.cpp\\GLOBAL\\AKA_INSTANCE___TreeNode\\AKA_INSTANCE___TreeNode\\TreeNode()");AKA_fCall++;auto EXPECTED_AKA_GLOBAL_AKA_INSTANCE___TreeNode = new ::TreeNode();
/* NormalNumberDataNode val */
/* val : null value -> no code */
/* PointerStructureDataNode left */
...
int main()
{
    ...
    /* add & run the tests */
	AKA_run_test("TREENODE_RANDOM_0", &AKA_TEST_TreeNode_random_0, 1);
