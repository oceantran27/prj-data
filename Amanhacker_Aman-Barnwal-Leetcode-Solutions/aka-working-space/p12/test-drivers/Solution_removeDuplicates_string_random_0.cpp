...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p12\\test-paths\\Solution_removeDuplicates_string_random_0.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p12\\execution-results\\Solution_removeDuplicates_string_random_0.trc"
...
#include "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p12\\instruments\1047-remove-all-adjacent-duplicates-in-string\1047-remove-all-adjacent-duplicates-in-string.akaignore.cpp"
...
void AKA_TEST_Solution_removeDuplicates_string_random_0(void) {
{
...
AKA_mark("Calling: \\Solution()|ROOT\\1047-remove-all-adjacent-duplicates-in-string.cpp\\GLOBAL\\AKA_INSTANCE___Solution\\AKA_INSTANCE___Solution\\Solution()");AKA_fCall++;AKA_INSTANCE___Solution = new ::Solution();


char* akaRandomName716666 = new char[2];akaRandomName716666[0] = 115;akaRandomName716666[1] = '\0';string s=akaRandomName716666;
...
AKA_fCall++;AKA_mark("Return from: .\\p12\\1047-remove-all-adjacent-duplicates-in-string\\1047-remove-all-adjacent-duplicates-in-string.cpp\\Solution\\removeDuplicates(string)");
...
int main()
{
    ...
    /* add & run the tests */
	AKA_run_test("SOLUTION_REMOVEDUPLICATES_STRING_RANDOM_0", &AKA_TEST_Solution_removeDuplicates_string_random_0, 1);
