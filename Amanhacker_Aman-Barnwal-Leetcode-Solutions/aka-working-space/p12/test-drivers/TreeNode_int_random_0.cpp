...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p12\\test-paths\\TreeNode_int_random_0.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p12\\execution-results\\TreeNode_int_random_0.trc"
...
void AKA_TEST_TreeNode_int_random_0(void) {
{
...
int AKA_INSTANCE___TreeNode_x=37588476;
AKA_mark("<<PRE-CALLING>> Test TreeNode_int_random_0");AKA_mark("Calling: .\\p12\\105-construct-binary-tree-from-preorder-and-inorder-traversal\\105-construct-binary-tree-from-preorder-and-inorder-traversal.cpp\\TreeNode\\TreeNode(int)|ROOT\\105-construct-binary-tree-from-preorder-and-inorder-traversal.cpp\\GLOBAL\\AKA_INSTANCE___TreeNode\\AKA_INSTANCE___TreeNode\\TreeNode(int)");AKA_fCall++;AKA_INSTANCE___TreeNode = new ::TreeNode(AKA_INSTANCE___TreeNode_x);
...
int main()
{
    ...
    /* add & run the tests */
	AKA_run_test("TREENODE_INT_RANDOM_0", &AKA_TEST_TreeNode_int_random_0, 1);
