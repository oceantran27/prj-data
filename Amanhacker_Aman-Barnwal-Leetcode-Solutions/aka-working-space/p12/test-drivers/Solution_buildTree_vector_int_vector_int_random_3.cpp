...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p12\\test-paths\\Solution_buildTree_vector_int_vector_int_random_3.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p12\\execution-results\\Solution_buildTree_vector_int_vector_int_random_3.trc"
...
void AKA_TEST_Solution_buildTree_vector_int_vector_int_random_3(void) {
{
...
AKA_fCall++;AKA_mark("Return from: .\\p12\\105-construct-binary-tree-from-preorder-and-inorder-traversal\\105-construct-binary-tree-from-preorder-and-inorder-traversal.cpp\\Solution\\buildTree(vector<int>&,vector<int>&)");
...
int main()
{
    ...
    /* add & run the tests */
	AKA_run_test("SOLUTION_BUILDTREE_VECTOR_INT_VECTOR_INT_RANDOM_3", &AKA_TEST_Solution_buildTree_vector_int_vector_int_random_3, 1);
