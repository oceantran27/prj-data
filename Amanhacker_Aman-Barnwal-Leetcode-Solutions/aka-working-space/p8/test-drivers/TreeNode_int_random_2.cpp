...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p8\\test-paths\\TreeNode_int_random_2.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p8\\execution-results\\TreeNode_int_random_2.trc"
...
void AKA_TEST_TreeNode_int_random_2(void) {
{
...
int AKA_INSTANCE___TreeNode_x=1323012068;
AKA_mark("<<PRE-CALLING>> Test TreeNode_int_random_2");AKA_mark("Calling: .\\p8\\0951-flip-equivalent-binary-trees\\0951-flip-equivalent-binary-trees.cpp\\TreeNode\\TreeNode(int)|ROOT\\0951-flip-equivalent-binary-trees.cpp\\GLOBAL\\AKA_INSTANCE___TreeNode\\AKA_INSTANCE___TreeNode\\TreeNode(int)");AKA_fCall++;AKA_INSTANCE___TreeNode = new ::TreeNode(AKA_INSTANCE___TreeNode_x);
...
int main()
{
    ...
    /* add & run the tests */
	AKA_run_test("TREENODE_INT_RANDOM_2", &AKA_TEST_TreeNode_int_random_2, 1);
