...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p9\\test-paths\\Solution_isMatch_string_string_random_0.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p9\\execution-results\\Solution_isMatch_string_string_random_0.trc"
...
#include "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p9\\instruments\10-regular-expression-matching\10-regular-expression-matching.akaignore.cpp"
...
void AKA_TEST_Solution_isMatch_string_string_random_0(void) {
{
AKA_test_case_name="Solution_isMatch_string_string_random_0";
...
char* akaRandomName438387 = new char[2];akaRandomName438387[0] = -25;akaRandomName438387[1] = '\0';string s=akaRandomName438387;
char* akaRandomName731147 = new char[2];akaRandomName731147[0] = 62;akaRandomName731147[1] = '\0';string p=akaRandomName731147;
...
AKA_mark("<<PRE-CALLING>> Test Solution_isMatch_string_string_random_0");bool AKA_ACTUAL_OUTPUT=AKA_INSTANCE___Solution->isMatch(s,p);
AKA_fCall++;AKA_mark("Return from: .\\p9\\10-regular-expression-matching\\10-regular-expression-matching.cpp\\Solution\\isMatch(string,string)");
...
int main()
{
    ...
    /* add & run the tests */
	AKA_run_test("SOLUTION_ISMATCH_STRING_STRING_RANDOM_0", &AKA_TEST_Solution_isMatch_string_string_random_0, 1);
