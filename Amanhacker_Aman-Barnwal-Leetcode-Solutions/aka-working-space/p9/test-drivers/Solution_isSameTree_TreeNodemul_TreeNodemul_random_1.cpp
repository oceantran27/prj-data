...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p9\\test-paths\\Solution_isSameTree_TreeNodemul_TreeNodemul_random_1.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p9\\execution-results\\Solution_isSameTree_TreeNodemul_TreeNodemul_random_1.trc"
...
void AKA_TEST_Solution_isSameTree_TreeNodemul_TreeNodemul_random_1(void) {
{
AKA_test_case_name="Solution_isSameTree_TreeNodemul_TreeNodemul_random_1";
...
AKA_mark("<<PRE-CALLING>> Test Solution_isSameTree_TreeNodemul_TreeNodemul_random_1");bool AKA_ACTUAL_OUTPUT=AKA_INSTANCE___Solution->isSameTree(p,q);
AKA_fCall++;AKA_mark("Return from: .\\p9\\100-same-tree\\100-same-tree.cpp\\Solution\\isSameTree(TreeNode*,TreeNode*)");
...
int main()
{
    ...
    /* add & run the tests */
	AKA_run_test("SOLUTION_ISSAMETREE_TREENODEMUL_TREENODEMUL_RANDOM_1", &AKA_TEST_Solution_isSameTree_TreeNodemul_TreeNodemul_random_1, 1);
