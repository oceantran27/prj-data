...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p9\\test-paths\\Solution_twoSum_vector_int_int_random_0.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p9\\execution-results\\Solution_twoSum_vector_int_int_random_0.trc"
...
#include "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p9\\instruments\1-two-sum\1-two-sum.akaignore.cpp"
...
void AKA_TEST_Solution_twoSum_vector_int_int_random_0(void) {
{
AKA_test_case_name="Solution_twoSum_vector_int_int_random_0";
...
AKA_mark("<<PRE-CALLING>> Test Solution_twoSum_vector_int_int_random_0");vector<int> AKA_ACTUAL_OUTPUT=AKA_INSTANCE___Solution->twoSum(v,tar);
AKA_fCall++;AKA_mark("Return from: .\\p9\\1-two-sum\\1-two-sum.cpp\\Solution\\twoSum(vector<int>&,int)");
...
int main()
{
    ...
    /* add & run the tests */
	AKA_run_test("SOLUTION_TWOSUM_VECTOR_INT_INT_RANDOM_0", &AKA_TEST_Solution_twoSum_vector_int_int_random_0, 1);
