...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p11\\test-paths\\Solution_zigzagLevelOrder_TreeNodemul_random_2.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p11\\execution-results\\Solution_zigzagLevelOrder_TreeNodemul_random_2.trc"
...
void AKA_TEST_Solution_zigzagLevelOrder_TreeNodemul_random_2(void) {
{
AKA_test_case_name="Solution_zigzagLevelOrder_TreeNodemul_random_2";
...
int root0_x=1439998020;
AKA_mark("Calling: .\\p11\\103-binary-tree-zigzag-level-order-traversal\\103-binary-tree-zigzag-level-order-traversal.cpp\\TreeNode\\TreeNode(int)|ROOT\\103-binary-tree-zigzag-level-order-traversal.cpp\\zigzagLevelOrder(TreeNode*)\\root\\AKA_VECTOR_INIT_root_0\\root\\TreeNode(int)");AKA_fCall++;auto AKA_VECTOR_INIT_root_0 = new ::TreeNode(root0_x);
...
AKA_mark("<<PRE-CALLING>> Test Solution_zigzagLevelOrder_TreeNodemul_random_2");vector<vector<int>> AKA_ACTUAL_OUTPUT=AKA_INSTANCE___Solution->zigzagLevelOrder(root);
...
int main()
{
    ...
    /* add & run the tests */
	AKA_run_test("SOLUTION_ZIGZAGLEVELORDER_TREENODEMUL_RANDOM_2", &AKA_TEST_Solution_zigzagLevelOrder_TreeNodemul_random_2, 1);
