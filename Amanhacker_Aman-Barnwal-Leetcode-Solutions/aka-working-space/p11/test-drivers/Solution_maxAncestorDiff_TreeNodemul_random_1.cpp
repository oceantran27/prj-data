...
#define AKA_TEST_PATH_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p11\\test-paths\\Solution_maxAncestorDiff_TreeNodemul_random_1.tp"
...
#define AKA_EXEC_TRACE_FILE "D:\\Projects\\AKAUT\\prj-data\\Amanhacker_Aman-Barnwal-Leetcode-Solutions\\aka-working-space\\p11\\execution-results\\Solution_maxAncestorDiff_TreeNodemul_random_1.trc"
...
void AKA_TEST_Solution_maxAncestorDiff_TreeNodemul_random_1(void) {
{
AKA_test_case_name="Solution_maxAncestorDiff_TreeNodemul_random_1";
...
AKA_mark("<<PRE-CALLING>> Test Solution_maxAncestorDiff_TreeNodemul_random_1");int AKA_ACTUAL_OUTPUT=AKA_INSTANCE___Solution->maxAncestorDiff(root);
...
int main()
{
    ...
    /* add & run the tests */
	AKA_run_test("SOLUTION_MAXANCESTORDIFF_TREENODEMUL_RANDOM_1", &AKA_TEST_Solution_maxAncestorDiff_TreeNodemul_random_1, 1);
