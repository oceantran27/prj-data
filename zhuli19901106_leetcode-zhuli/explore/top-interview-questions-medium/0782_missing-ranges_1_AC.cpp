...
private:
    void insert(int64_t i, map<int64_t, int64_t> &m1, map<int64_t, int64_t> &m2, int64_t lower, int64_t upper) {
        int64_t left, right;
    ...
    string interval(int64_t x, int64_t y) {
